...
let g:colors_name='gruvbox-neon'
...
let s:gb.bright_red     = ['#9500ff', 92]     " 251-73-52
let s:gb.bright_green   = ['#46d9ff', 45]     " 184-187-38
let s:gb.bright_yellow  = ['#c2c2ff', 183]     " 250-189-47
let s:gb.bright_blue    = ['#9eddff', 177]     " 131-165-152
let s:gb.bright_purple  = ['#05f57d', 157]     " 177-98-134
let s:gb.bright_aqua    = ['#51afef', 74]     " 142-192-124
let s:gb.bright_orange  = ['#9ce2fb', 159]     " 254-128-25
let s:gb.bright_cyan    = ['#77ffd7', 159]     " 254-128-25
let s:gb.bright_magenta = ['#c263f9', 159]     " 254-128-25

let s:gb.neutral_red    = ['#a040ff', 92]     " 204-36-29
let s:gb.neutral_green  = ['#0bffef', 45]     " 152-151-26
let s:gb.neutral_yellow = ['#77ffd7', 183]     " 215-153-33
let s:gb.neutral_blue   = ['#ccaaff', 177]      " 69-133-136
let s:gb.neutral_purple = ['#ff00f4', 157]     " 177-98-134
let s:gb.neutral_aqua   = ['#2257a0', 74]      " 104-157-106
let s:gb.neutral_orange = ['#61ffff', 159]     " 214-93-14
let s:gb.neutral_cyan   = ['#77ffd7', 159]     " 254-128-25
let s:gb.neutral_magenta= ['#b763f9', 159]     " 254-128-25

let s:gb.faded_red      = ['#7500ff', 92]      " 157-0-6
let s:gb.faded_green    = ['#41e1ff', 45]     " 121-116-14
let s:gb.faded_yellow   = ['#19d3d3', 183]     " 181-118-20
let s:gb.faded_blue     = ['#ccbbff', 177]      " 7-102-120
let s:gb.faded_purple   = ['#00ffaf', 157]      " 143-63-113
let s:gb.faded_aqua     = ['#cd1bfd', 74]      " 66-123-88
let s:gb.faded_orange   = ['#42ffff', 159]     " 175-58-3
let s:gb.faded_cyan     = ['#77ffd7', 159]     " 254-128-25
let s:gb.faded_magenta  = ['#ce63f9', 159]     " 254-128-25
...
call s:HL('GruvboxCyan', s:cyan)
call s:HL('GruvboxCyanBold', s:cyan, s:none, s:bold)
call s:HL('GruvboxMagenta', s:magenta)
call s:HL('GruvboxMagentaBold', s:magenta, s:none, s:bold)
call s:HL('GruvboxPink', s:pink)
call s:HL('GruvboxPinkBold', s:pink, s:none, s:bold)
...
call s:HL('GruvboxCyanSign', s:cyan, s:sign_column, s:invert_signs)
...
hi! link TagbarAccessProtected GruvboxOrange
hi! link TagbarVisibilityPrivate GruvboxYellow
hi! link TagbarVisibilityPublic GruvboxBlue
hi! link FloatermBorder GruvboxYellow
...
" call s:HL('ErrorMsg',   s:purple, s:bg0)
" More prompt: -- More --
...
hi! link Operator GruvboxCyan
" Any other keyword
" hi! link Keyword GruvboxRed
hi! link Keyword GruvboxMagenta
...
" SpecialChar
hi! link SpecialChar GruvboxPurple
...
hi! link CocErrorSign GruvboxYellowSign
hi! link CocHintSign GruvboxAquaSign
hi! link CocInfoSign GruvboxRedSign
hi! link CocWarningSign GruvboxBlueSign
"
"}}}
" IndentLine: {{{
...
hi! link GitGutterAdd GruvboxRedSign
hi! link GitGutterChange GruvboxAquaSign
hi! link GitGutterDelete GruvboxPurpleSign
hi! link GitGutterChangeDelete GruvboxPurpleSign
...
hi! link StartifyPath GruvboxBlue
hi! link StartifySlash GruvboxBlue
hi! link StartifySection GruvboxRed
hi! link StartifySpecial GruvboxBg4
hi! link StartifyHeader GruvboxYellow
hi! link StartifyFooter GruvboxBg4
...
" hi! link cssClassName GruvboxRed
...
hi! link cssBraces GruvboxOrange
hi! link cssFunctionName GruvboxYellow
hi! link cssIdentifier GruvboxRed
hi! link cssClassName GruvboxRed
hi! link cssColor GruvboxGreen
hi! link cssSelectorOp GruvboxYellow
hi! link cssSelectorOp2 GruvboxYellow
hi! link cssImportant GruvboxCyan
hi! link cssVendor GruvboxFg0

hi! link cssTextProp GruvboxOrange
hi! link cssAnimationProp GruvboxOrange
hi! link cssUIProp GruvboxFg0
...
hi! link cssMarginProp GruvboxOrange
...
"
" hi! link markdownCode GruvboxCyan
" hi! link markdownCodeBlock GruvboxCyan
" hi! link markdownCodeDelimiter GruvboxCyan
"
...
"
" hi! link markdownHeadingDelimiter GruvboxAqua
...
hi! link markdownBlockquote GruvboxGray
hi! link markdownListMarker GruvboxCyan
hi! link markdownOrderedListMarker GruvboxCyan
hi! link markdownRule GruvboxYellow
hi! link markdownHeadingRule GruvboxOrange
...
" highlight Special guifg=#46d9ff

...
hi! Error cterm=NONE gui=NONE ctermbg=233 ctermfg=203 guibg=#00010695 guifg=#eC6a88
hi! ErrorMsg cterm=NONE gui=NONE ctermbg=233 ctermfg=203 guibg=#00010695 guifg=#ec6a88
hi! WarningMsg cterm=NONE gui=NONE ctermbg=233 ctermfg=203 guibg=#00010695 guifg=#eC6a88
...
hi! ALEErrorSign cterm=NONE gui=NONE ctermbg=233 ctermfg=203 guibg=#00010695 guifg=#eC6a88
...
hi! GitGutterChange cterm=NONE gui=NONE ctermbg=233 ctermfg=109 guibg=#00010695 guifg=#e95678
hi! GitGutterChangeDelete cterm=NONE gui=NONE ctermbg=233 ctermfg=109 guibg=#00010695 guifg=#e95678
hi! GitGutterDelete cterm=NONE gui=NONE ctermbg=233 ctermfg=203 guibg=#00010695 guifg=#eC6a88
...
hi! SyntasticErrorSign cterm=NONE gui=NONE ctermbg=233 ctermfg=203 guibg=#00010695 guifg=#eC6a88
hi! SyntasticStyleErrorSign cterm=NONE gui=NONE ctermbg=233 ctermfg=203 guibg=#00010695 guifg=#eC6a88
...
if has('nvim')
  ...
  let g:terminal_ansi_colors = ['#00010695', '#eC6a88', '#09f7a0', '#fab795', '#25b0bc', '#f09483', '#e95678', '#00010695', '#d5d8da', '#ec6a88', '#6bdfe6', '#fab38e', '#21bfc2', '#b877db', '#95c4ce', '#d2d4de']
endif

...
let s:gb.bright_purple  = ['#77ffd7', 157]     " 177-98-134
let s:gb.bright_aqua    = ['#1dc8ed', 74]     " 142-192-124
let s:gb.bright_orange  = ['#9ce2fb', 159]     " 254-128-25
let s:gb.bright_cyan    = ['#05f57d', 159]     " 254-128-25
...
let s:gb.neutral_purple = ['#55ff6f', 157]     " 177-98-134
...
let s:gb.faded_aqua     = ['#51afef', 74]      " 66-123-88
...
call s:HL('Error', s:pink, s:none, s:bold . s:inverse)

...
" --- https://github.com/morhetz/aurora/issues/7
if s:is_dark
  set background=dark
else
...
hi! link Operator AuroraPurple
" Any other keyword
hi! link Keyword AuroraRed

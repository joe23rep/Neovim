...
let s:p.inactive.right = [ [ '#292c33', '#ff00ff', s:term_black, s:term_blue], [ '#abb2bf', '#3e4452', s:term_white, s:term_grey ] ]
let s:p.inactive.left = s:p.inactive.right[1:]
" her
let s:p.insert.left = [ [ '#292c33', '#ff00ff', s:term_black, s:term_blue, 'bold' ], [ '#ff00ff', '#292c33', s:term_blue, s:term_black ] ]
let s:p.insert.right = [ [ '#292c33', '#ff00ff', s:term_black, s:term_blue ], [ '#ABB2BF', '#3E4452', s:term_white, s:term_grey ], [ '#ff00ff', '#292c33', s:term_blue, s:term_black ] ]
let s:p.replace.left = [ [ '#292c33', '#ff00d4', s:term_black, s:term_red, 'bold' ], [ '#ff00d4', '#292c33', s:term_red, s:term_black ] ]
let s:p.replace.right = [ [ '#292c33', '#ff00d4', s:term_black, s:term_red, 'bold' ], s:p.normal.right[1], [ '#ff00d4', '#292c33', s:term_red, s:term_black ] ]
...
let s:p.normal.error = [ [ '#292c33', '#ff00d4', s:term_black, s:term_red ] ]
